...
本プロジェクトでは、一部のコード生成に一般的な無料生成 AI を利用しています。
AI は高速に構文エラーのないコードを生成できる一方で、以下の特性から 仕様逸脱や構造的な不具合 を生む場合があります。
...
などを重点的に確認する必要があります。
AI によるコード生成は開発効率を高めますが、
従来とは異なる種類の注意点（構造バグ）が存在するため、
現時点では「AI は補助として利用し、複雑な部分は人間が書く」方針を推奨します。
